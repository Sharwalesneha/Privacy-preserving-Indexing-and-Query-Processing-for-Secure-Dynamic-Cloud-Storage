	...
	<head>
      ...
      <form action="tpa_verify.jsp"method="get"name="name"  onsubmit="return validate()">
          <strong style="color: #4cd3e3;"> TPA NAME:</strong><br>
      <input type="text" name="tpid"placeholder="enter name"></input><br><BR>
