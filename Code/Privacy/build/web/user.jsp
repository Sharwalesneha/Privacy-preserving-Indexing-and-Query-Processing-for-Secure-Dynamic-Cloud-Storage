					...
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<h1 class="text-white">
							 ...
							 <form action="user_login"method="get"name="name"  onsubmit="return validate()">
          <strong style="color: #4cd3e3;"> USER NAME:</strong><br>
      <input type="text" name="username"placeholder="enter  name"></input><br><br>
