...
<html lang="zxx" class="no-js">
    ...
    <table align="center" border="1" bordercolor="white"  cellspacing="1px" cellpadding="10px" width="10px">
        ...
        <th><font color='Red'>USER FROM</font></th>
        <th><font color='Red'>FILE NAME</font></th>
         <th><font color='Red'>VIEW FILE</font></th>
        ...
        try{
         ...
         <tr>
             ...
             <td><font color='white'><%=filename%></font></td>
               <td><a href="viewfiles.jsp?fileid=<%=fileid%>" ><font color='blue'>VIEWFILE</font></a></td>
                <td><a href="reqdb.jsp?fileid=<%=fileid%>&&filename=<%=filename%>&&ownername=<%=ownername%>"><font color='YELLOW'>REQUEST</font></a></td>
