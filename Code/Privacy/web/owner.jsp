					...
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<h1 class="text-white">
							 ...
							 <form action="ownerlogin"method="get"name="name"  onsubmit="return validate()">
          <strong style="color: #4cd3e3;"> OWNER NAME:</strong><br>
      <input type="text" name="ownername"placeholder="enter  name"></input><br><br>
          <strong style="color: #4cd3e3;">PASSWORD:</strong><br>
          <input type="password" name="password"placeholder="enter password"></input><br></br>
          <input type="submit" value="SignIn"></input><br><br><br><BR><BR>
