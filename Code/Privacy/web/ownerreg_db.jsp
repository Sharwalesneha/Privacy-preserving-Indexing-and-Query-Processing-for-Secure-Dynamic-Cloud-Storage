...
//   Connection con=DbConnection.getConnection();
  ...
  int i=st.executeUpdate( "INSERT INTO owner (ownername,password,emailid,contactno,gender,state,country,dob) VALUES('"+ownername+"','"+password+"','"+emailid+"','"+contactno+"','"+gender+"','"+state+"','"+country+"','"+dob+"')");
   con.close();
   if(i!=0){
