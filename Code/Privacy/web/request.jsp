...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <table align="center" border="1" bordercolor="YELLOW"  cellspacing="1px" cellpadding="10px" width="10px">
      ...
      <%
        ...
        int sno = 0;
        try{
         String query = "select *from shareinfo where fileto='"+username+"'";
         con = DBConnectionn.getConnection();
         ps = con.prepareStatement(query);       
         rs = ps.executeQuery();
         while(rs.next()){
             String fileid = rs.getString(1);
          String filefrom = rs.getString(2);
          String fileto= rs.getString(3);
          String index= rs.getString(4);
           String filename= rs.getString(5);
            String privatekey= rs.getString(6);
          
       %>
         <tr>
             <td><font color='white'><%=fileid%></font></td>
             <td><font color='white'><%=filefrom%></font></td>
             <td><font color='white'><%=fileto%></font></td>
             <td><font color='white'><%=index%></font></td>
             <td><font color='white'><%=filename%></font></td>
             <td><a style="color: yellow" href="Approver?privatekey=<%=privatekey%>">SEND REQUEST TO TPA</a></td>      
         </tr>
