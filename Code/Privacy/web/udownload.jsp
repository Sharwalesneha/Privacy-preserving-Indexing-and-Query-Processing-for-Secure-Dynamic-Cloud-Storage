...
<html lang="zxx" class="no-js">
    ...
    <table align="center" border="1" bordercolor="YELLOW"  cellspacing="1px" cellpadding="10px" width="10px">
        ...
        String query = "select *from filerequest";
         ...
         String privatekey= rs.getString(7);
         String aggrigatekey= rs.getString(8);
         ...
         <tr>
             ...
             <td><a style="color: yellow" href="download.jsp?fileid=<%=fileid%>&&privatekey=<%=privatekey%>&&aggkey=<%=aggrigatekey%>&&filename=<%=filename%>">DOWNLOAD</a></td>      
      </tr>
